    ...
    <div className="train-selector">
      <div className="train-list_header">
        ...
        <div className="train-list_sort">
          ...
          >
            <option className="train-list_sort-item" value="time">времени</option>
            <option className="train-list_sort-item" value="price_min">стоимости</option>
            <option className="train-list_sort-item" value="duration">длительности</option>
          </select>
        </div>
        ...
        <div className="train-list_view">
          ...
          <ul className="train-list_view-list">
            {limits.map((el) => (
              <li
                className={`train-list_view-item ${limit === el ? 'train-list_view-item--active' : ''
                  }`}
                key={el}
